...
<div class="min-h-screen bg-gray-50/50 py-10 font-sans">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
            ...
            <div class="px-8 pb-6 flex flex-col md:flex-row items-start md:items-end -mt-10 gap-6">
                ...
                <div class="relative flex-shrink-0">
                    ...
                    <div class="absolute bottom-1 right-1 w-5 h-5 bg-emerald-500 border-2 border-white rounded-full flex items-center justify-center" title="Status Aktif">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                <h1 class="text-2xl font-bold text-gray-900 leading-tight">Halo, {{ explode(' ', Auth::user()->name)[0] }}!</h1>
                                <span class="px-2.5 py-0.5 bg-blue-50 text-blue-700 text-[10px] font-bold uppercase tracking-wider rounded-md border border-blue-100">
                                    Pencari Kost
                                </span>
                            </div>
                        ...
                        <div class="flex items-center gap-3">
                            <a href="{{ route('user.profile') }}" class="px-5 py-2.5 bg-white border border-gray-200 text-gray-600 text-sm font-bold rounded-xl hover:bg-gray-50 hover:text-orange-600 hover:border-orange-200 transition shadow-sm">
                                ⚙️ Edit Profil
                            </a>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            {{-- Card 1: Status Email --}}
            <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between group hover:border-orange-200 transition">
                <div>
                ...
                <div class="w-10 h-10 rounded-full flex items-center justify-center {{ Auth::user()->hasVerifiedEmail() ? 'bg-emerald-50 text-emerald-600' : 'bg-amber-50 text-amber-600' }}">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="relative z-10">
                        ...
                        <form action="{{ route('kost.public') }}" method="GET">
                            <div class="flex gap-2 bg-white p-1.5 rounded-xl shadow-lg">
                                ...
                                <button type="submit" class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2.5 rounded-lg font-bold text-sm transition">
                                    Cari
                                </button>
                            </div>
                        </form>
                        ...
                        <div class="mt-6 flex flex-wrap gap-2">
                            <span class="text-xs text-gray-400 font-bold uppercase tracking-wider mr-1">Populer:</span>
                            <a href="{{ route('kost.public', ['search' => 'Putra']) }}" class="px-3 py-1 bg-white/10 hover:bg-white/20 rounded-full text-xs font-medium transition cursor-pointer">Kost Putra</a>
                            <a href="{{ route('kost.public', ['search' => 'Putri']) }}" class="px-3 py-1 bg-white/10 hover:bg-white/20 rounded-full text-xs font-medium transition cursor-pointer">Kost Putri</a>
                            <a href="{{ route('kost.public', ['search' => 'AC']) }}" class="px-3 py-1 bg-white/10 hover:bg-white/20 rounded-full text-xs font-medium transition cursor-pointer">Ber-AC</a>
                        </div>
                    </div>
                    {{-- Decor --}}
                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-8 text-center">
                    ...
                    <h4 class="text-gray-900 font-bold mb-1">Riwayat pencarian masih kosong</h4>
                    <p class="text-gray-500 text-xs mb-0">Mulai menjelajah untuk melihat riwayat kost yang Anda kunjungi di sini.</p>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                    ...
                    <div class="relative border-l-2 border-gray-50 ml-2 space-y-6 pl-6">
                        ...
                        {{-- Log Item Suggestion --}}
                        <div class="relative group">
                            <span class="absolute -left-[31px] top-1.5 w-3 h-3 rounded-full bg-blue-200 ring-4 ring-white animate-pulse"></span>
                            <p class="text-sm font-bold text-gray-800">Lengkapi Profil Anda</p>
                            <a href="{{ route('user.profile') }}" class="text-xs text-blue-600 hover:underline mt-0.5 block">Tambahkan no HP & alamat &rarr;</a>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                    ...
                    <a href="{{ route('panduan') }}" class="px-4 py-2 bg-gray-50 text-gray-700 text-xs font-bold rounded-lg hover:bg-gray-100 transition border border-gray-200 w-full">
                        Baca Panduan
                    </a>
                </div>
