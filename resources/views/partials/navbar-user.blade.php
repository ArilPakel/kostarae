<nav x-data="{ mobileOpen: false, userDropdownOpen: false }" class="fixed top-0 left-0 w-full z-50 bg-[#2D4A53] shadow-md font-sans">
    ...
    <div class="px-4 py-3 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-6">
            <a href="{{ route('home') }}" class="text-white hover:text-gray-200 transition font-medium {{ request()->routeIs('home') ? 'font-bold underline decoration-orange-500 underline-offset-4' : '' }}">Beranda</a>
            ...
            <div class="relative">
                ...
                <div x-show="userDropdownOpen" x-transition 
                    ...
                    @if(Auth::user()->role === 'pemilik' || Auth::user()->role === 'owner')
                        {{-- MENU PEMILIK --}}
                        <a href="{{ route('owner.profile') }}" class="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 text-gray-700 font-medium transition-colors">
